export type ActiveView = 'songs' | 'artists' | 'albums' | 'genres' | 'playlists' | 'settings';
...
export function iconPath(icon: string): string {
  const icons: Record<string, string> = {
    ...
    disc: 'M4 2h15a2 2 0 0 1 2 2v14 M2 6a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6z M10.5 7.5a5 5 0 1 0 0 10 5 5 0 0 0 0-10z M10.5 11a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z',
    genre: 'M2 10v4 M6 7v10 M10 3v18 M14 5v14 M18 8v8 M22 10v4',
